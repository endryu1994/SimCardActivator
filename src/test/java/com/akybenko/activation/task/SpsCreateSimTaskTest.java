...
public class SpsCreateSimTaskTest extends AbstractTaskTest {

    @InjectMocks
    private SpsCreateSimTask task;

    @Before
    public void setUp() {
        when(webService.getSpsCreateSimResponse(any())).thenReturn(getResponse(STATUS_CODE_WS_OK));
    }
